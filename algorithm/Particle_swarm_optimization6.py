...
def solvePSO(N, K, distance_matrix):
    pso_solver = PSO_VRP_Solver("")
    pso_solver.takeInput(N, K, distance_matrix)
    pso_solver.reset()
    pso_solver.precompute_distances()
    pso_solver.solve()

    plans, max_route_distance = pso_solver.getResult()
